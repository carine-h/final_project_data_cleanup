...
```{r}
m <- m%>%
  mutate(urban_r=if_else(urban_r=="Rural", "Rural","Urban"))%>%
  mutate(urban_p1=if_else(urban_r=="Rural", "Rural","Urban"))%>%
  mutate(urban_p2=if_else(urban_r=="Rural", "Rural","Urban"))%>%
  mutate(urban_p3=if_else(urban_r=="Rural", "Rural","Urban"))%>%
  mutate(urban_p4=if_else(urban_r=="Rural", "Rural","Urban"))
