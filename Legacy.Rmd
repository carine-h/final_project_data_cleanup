...
write_rds(data_plot_legacy, "~/Desktop/R studio/final_project_data_cleanup/shiny/legacy/barplot_legacy.rds")
```
...
write_rds(legacy_violin, "~/Desktop/R studio/final_project_data_cleanup/shiny/legacy/violin_legacy.rds")
```
...
write_rds(legacy_yes_permutation_plot, "~/Desktop/R studio/final_project_data_cleanup/shiny/legacy/legacy_yes_permutation.rds")
```
...
write_rds(legacy_no_permutation_plot, "~/Desktop/R studio/final_project_data_cleanup/shiny/legacy/legacy_no_permutation.rds")
```
