...
write_rds(data_plot_concentration, "~/Desktop/GOV_1005/final_project_data_cleanup/shiny/concentration/barplot_concentration.rds")
...
write_rds(concentration_violin, "~/Desktop/GOV_1005/final_project_data_cleanup/shiny/concentration/violin_concentration.rds")
```
...
write_rds(stem_permutation_plot, "~/Desktop/GOV_1005/final_project_data_cleanup/shiny/concentration/stem_permutation.rds")
```
...
write_rds(humanities_permutation_plot, "~/Desktop/GOV_1005/final_project_data_cleanup/shiny/concentration/humanities_permutation.rds")
```
...
write_rds(social_sciences_permutation_plot, "~/Desktop/GOV_1005/final_project_data_cleanup/shiny/concentration/social_sciences_permutation.rds")
```
