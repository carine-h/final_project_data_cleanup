...
write_rds(data_plot_religion, "~/Desktop/R studio/final_project_data_cleanup/shiny/religion/barplot_religion.rds")
...
religion_violin <- m %>%
  ...
  labs(title = "Distribution of Same Religion Friends per Respondent Religion", y = "Number of Same Religion Friends") +
  theme(legend.position = "none")

religion_violin

write_rds(religion_violin, "~/Desktop/R studio/final_project_data_cleanup/shiny/religion/violin_religion.rds")
```
...
write_rds(christian_permutation_plot, "~/Desktop/R studio/final_project_data_cleanup/shiny/religion/christian_permutation.rds")
...
write_rds(agnostic_or_atheist_permutation_plot, "~/Desktop/R studio/final_project_data_cleanup/shiny/religion/agnostic_or_atheist_permutation.rds")
