...
write_rds(data_plot_athlete, "~/Desktop/R studio/final_project_data_cleanup/shiny/athlete/barplot_athlete.rds")
```
...
write_rds(athlete_violin, "~/Desktop/R studio/final_project_data_cleanup/shiny/athlete/violin_athlete.rds")
```
...
write_rds(athlete_yes_permutation_plot, "~/Desktop/R studio/final_project_data_cleanup/shiny/athlete/athlete_yes_permutation.rds")
```
...
write_rds(athlete_no_permutation_plot, "~/Desktop/R studio/final_project_data_cleanup/shiny/athlete/athlete_no_permutation.rds")
```