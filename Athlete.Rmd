...
athlete_yes_permutation_plot<- athlete_yes_replications %>%
  ...
  labs(title = "Distribution of Mean Number of Athlete Friends per Athlete Respondent Under the Null Hypothesis", subtitle = "Our observed value, shown in blue, is smaller than we would expect under random friend assignment", x = "Mean Number of `Same Status` Friends (Athlete) per Replication",y = "Density")
...
athlete_no_permutation_plot<- athlete_no_replications %>%
  ...
  labs(title = "Distribution of Mean Number of Non-Athlete Friends per Non-Athlete Respondent Under the Null Hypothesis", subtitle = "Our observed value, shown in blue, is smaller than we would expect under random friend assignment", x = "Mean Number of `Same Status` Friends (Non-Athlete) per Replication",y = "Density")
