...
write_rds(data_plot_urban, "~/Desktop/R studio/final_project_data_cleanup/shiny/urban/barplot_urban.rds")
```
...
write_rds(urban_violin, "~/Desktop/R studio/final_project_data_cleanup/shiny/urban/violin_urban.rds")
```
...
write_rds(rural_permutation_plot, "~/Desktop/R studio/final_project_data_cleanup/shiny/urban/rural_permutation.rds")
```
...
write_rds(urban_permutation_plot, "~/Desktop/R studio/final_project_data_cleanup/shiny/urban/urban_permutation.rds")
```
